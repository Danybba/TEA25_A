...
ride_type = input("Möchten Sie ein Fahrtenupgrade plus oder comfort? (plus/comfort/keins): ")
credits = int(input("Geben Sie die Anzahl Ihrer verfügbaren Credits ein: "))
...
print("Der Fahrpreis beträgt:", ride_price, "€")
...
print("Der finale Fahrpreis beträgt:", final_price, "€")
