...
- Erstelle eine too_low Variable, welche uns sagen wird ob die Frequenz zu niedrig ist.
...
"""
heart_rate = int(input("Geben Sie die Herzfrequenz ein: "))
too_low = heart_rate < 60
too_high = heart_rate > 100

print("Heart rate low:", too_low)
print("Heart rate high:", too_high)
